...
<table>
<tr>
<td><img src="docs/images/13-name-autocomplete.png" width="225"></td>
<td><img src="docs/images/14-menu-search.png" width="225"></td>
<td><img src="docs/images/15-cart-bottom.png" width="225"></td>
</tr>
<tr>
<td align="center">名字記在手機裡，跳出來讓你點</td>
<td align="center">打「炸」就篩出來，連自填鍵都跟著改</td>
<td align="center">購物車收合在底部，滑到哪都送得出去</td>
</tr>
</table>
...
<table>
<tr>
<td><img src="docs/images/16-progress-sort.png" width="235"></td>
<td><img src="docs/images/17-withdrawn.png" width="235"></td>
</tr>
<tr>
<td align="center">進度照狀態分組，可換名稱／叫單時間排序</td>
<td align="center">撤掉的單留著、標成「已撤單」，不進金額</td>
</tr>
</table>
...
（這一段的畫面在前面看得到：四份可複製的彙總在上面的〈結帳〉截圖，首頁兩塊清單與「幾點開的」在最上面那張首頁截圖。）
